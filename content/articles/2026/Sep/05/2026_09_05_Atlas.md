...
<a class="atlas-flow-figure" href="https://mchromiak.github.io/articles/2026/Sep/05/Atlas-World-Model-for-Spatial-Intelligence/" aria-label="Open the canonical Atlas article by Michał Chromiak"><picture><source media="(prefers-reduced-motion: reduce)" srcset="img/atlas-conceptual-flow.svg?v=20260905" width="1200" height="700"><source media="(min-width: 601px)" srcset="img/atlas-request-flow.webp?v=20260905-2" width="1200" height="675"><img src="{attach}img/atlas-request-flow-mobile.webp?v=20260905" width="720" height="1100" loading="lazy" decoding="async" alt="Animated conceptual Atlas workflow: text, images, depth maps, and camera poses form a spatial context; a target camera requests the next element, rectified flow resolves the output, and the result can extend the context."></picture></a>

Figure 2. An original conceptual flow based on [World Labs' public model description](https://www.worldlabs.ai/blog/atlas#model-architecture). The animation shows evidence entering a shared spatial context, a target camera pose requesting the next element, and rectified flow resolving the new view. It explains the relationship between published components; it is not a diagram of undisclosed internal modules. The [animated WebP]({attach}img/atlas-request-flow.webp) loops automatically; a [static diagram]({attach}img/atlas-conceptual-flow.svg) is shown when reduced motion is requested. (Copyright: &copy; 2026 [Michał Chromiak](https://mchromiak.github.io/articles/2026/Sep/05/Atlas-World-Model-for-Spatial-Intelligence/)).
{: align=center }
...
Figure 3. The geometric bridge from a depth map to a point cloud. This original, general camera-geometry diagram explains the reconstruction concept; it is not an Atlas implementation diagram. (Copyright: &copy; 2026 [Michał Chromiak](https://mchromiak.github.io/articles/2026/Sep/05/Atlas-World-Model-for-Spatial-Intelligence/)).
{: align=center }
...
Figure 4. An official example associated with Atlas's explicit 3D outputs. The still image conveys appearance, but the original interactive demonstration is needed to inspect view consistency and geometry. (Source: [World Labs](https://www.worldlabs.ai/blog/atlas#explicit-3d-outputs)).
{: align=center }
...
Figure 6. An original chart of the camera-path adherence results reported by World Labs. Atlas received explicit camera geometry, whereas the comparison models received text descriptions of the requested motion. The chart evaluates path following, not overall video quality. Data source: [World Labs](https://www.worldlabs.ai/blog/atlas#benchmarks). (Copyright: &copy; 2026 [Michał Chromiak](https://mchromiak.github.io/articles/2026/Sep/05/Atlas-World-Model-for-Spatial-Intelligence/)).
{: align=center }
...
Figures 1, 4, and 5 are reproduced from World Labs' official Atlas materials for commentary and technical explanation; their captions link to the original online resources. Figures 2, 3, and 6 are original visualizations created for this article and are copyright &copy; 2026 [Michał Chromiak](https://mchromiak.github.io/articles/2026/Sep/05/Atlas-World-Model-for-Spatial-Intelligence/). Copyright in the reproduced material remains with World Labs.
