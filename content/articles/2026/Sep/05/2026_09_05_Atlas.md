...
<a class="atlas-flow-figure" href="https://mchromiak.github.io/articles/2026/Sep/05/Atlas-World-Model-for-Spatial-Intelligence/" aria-label="Open the canonical Atlas article by Michał Chromiak"><picture><source media="(prefers-reduced-motion: reduce)" srcset="img/atlas-conceptual-flow.svg" width="1200" height="700"><source media="(min-width: 601px)" srcset="img/atlas-request-flow.webp" width="1200" height="675"><img src="{attach}img/atlas-request-flow-mobile.webp" width="720" height="1100" loading="lazy" decoding="async" alt="Animated conceptual Atlas workflow: text, images, depth maps, and camera poses form a spatial context; a target camera requests the next element, rectified flow resolves the output, and the result can extend the context."></picture></a>
