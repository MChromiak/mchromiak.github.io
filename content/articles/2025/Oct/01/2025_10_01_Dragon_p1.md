...
Related_posts: Transformer-Attention-is-all-you-need, COLT5_Faster_Long-Range-Transformers-with-Conditional-Computation, Atlas-World-Model-for-Spatial-Intelligence
...
Start with the [Transformer guide](/articles/2017/Sep/12/Transformer-Attention-is-all-you-need/) for the architecture BDH is compared against. [CoLT5](/articles/2023/Mar/30/COLT5_Faster_Long-Range-Transformers-with-Conditional-Computation/) is a separate example of conditional computation, while [Atlas](/articles/2026/Sep/05/Atlas-World-Model-for-Spatial-Intelligence/) shifts the discussion from sequence mechanisms to spatial world models.
