...
To see how foundation models are moving beyond text, read [Atlas: How one model turns images into controllable 3D worlds]({filename}../../../2026/Sep/05/2026_09_05_Atlas.md). Atlas combines images, camera poses, depth, and text in a spatial context; QLoRA addresses the separate problem of adapting a pretrained language model within a limited memory budget.
